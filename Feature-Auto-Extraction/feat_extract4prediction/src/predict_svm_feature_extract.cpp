...
char in_path[MAX_STRING], suffix[MAX_STRING], out_file[MAX_STRING], uid_file[MAX_STRING], fid_file[MAX_STRING];
int debug_mode = 2;
...
int main(int argc, char **argv) {
    ...
    if (argc == 1) {
        ...
        printf("\nExamples:\n");
        printf("./predict_svm_f -in ./ -suffix txt -uid out/svm_features.txt.uid -fid out/svm_features.txt.fid -out out/svm_features_pre.txt -debug 2\n\n");
        return 0;
    }
    in_path[0] = 0;
    out_file[0] = 0;
